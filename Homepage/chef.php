...
<html lang="en">
    ...
    <home>
        ...
        <button type = "button" class = "bouton" onclick = "addRecipe()"> Ajouter une recette </button>

        <!-- Bouton utilisateurs -->
        <button type = "button" class = "bouton" onclick = "myRecipes('<?php echo $_SESSION['username'];?>')"> Mes Recettes </button>
        
        <!-- Liste de d'utilisateurs-->
        <div id="liste_users">
            <!-- appelle la fonction dès que la page est prête-->
            <script> $(document).ready(myRecipes('<?php echo $_SESSION['username'];?>')); </script>
        </div>
